...
#' @param display_plots [logical] (with default): enable/disable MCMC and ACF plots.
...
Compute_AgeS_D <- function(
  ...
  #### RESULTS_RUNJAGS REMOVED AS SEVERAL INDICATOR ARE CALCULATED WITHIN THE FUNCTION
  ...
  print(attributes(diagnostic_plots)$gelman_rubin)
  ...
  output <- .list_BayLum(
    ...
    "diagnostics_plots" = diagnostic_plots,
