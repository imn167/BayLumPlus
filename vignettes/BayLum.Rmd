...
**BayLumPlus** is built on top of **BayLum**. To use the new features effectively, you may need to understand the underlying BayLum workflows. This section links to and summarizes the original BayLum vignette.
