...
**BayLumPlus** is built on top of **BayLum**. To use the new features
effectively, you may need to understand the underlying BayLum workflows.
This section links to and summarizes the original BayLum vignette.
...
[`LT_RegenDose()`](https://imn167.github.io/BayLumPlus/reference/LT_RegenDose-deprecated.md):
...
[`combine_DataFiles()`](https://imn167.github.io/BayLumPlus/reference/combine_DataFiles.md).
